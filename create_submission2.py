...
predictions_path = sys.argv[1] # Original path
filename = os.path.splitext(os.path.basename(predictions_path))[0] # W/o folder
target_path = "submissions/%s.csv" % filename # Path to

...
class RescaledDataLoader(DataLoader):
    def create_random_gen(self, image_gen, labels):
        gen = data.rescaled_patches_gen_augmented(image_gen = image_gen, estimate_scale_func=self.estimate_scale, labels=True, patch_size=self.patch_size,
    ...
    def create_fixed_gen(self, image_gen, augment=False):
        ...
        gen = data.rescaled_patches_gen_fixed(image_gen=image_gen, estimate_scale_func=self.estimate_scale, patch_size=self.patch_size,
